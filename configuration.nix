...

{
  ...
  networking.hostId = "796ae201";

  networking.hostName = "barron"; # Define your hostname.
...
'';
  ...
  users.users.mike = {
    isNormalUser = true;
    description = "Mike Geggie";
    extraGroups = [ "docker" "networkmanager" "wheel" "plex"];
    packages = with pkgs; [
      firefox
    #  thunderbird
    ];
